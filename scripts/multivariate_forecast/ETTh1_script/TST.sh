...
--model-hyper-params '{"d_model": 512, "n_heads": 8, "num_layers": 1, "dim_feedforward": 2048, "dropout": 0.1, "pos_encoding": "rotary", "norm": true, "seq_len": 96, "horizon": 96, "batch_size": 32, "lr": 0.0001, "num_epochs": 100, "patience": 10}' \
